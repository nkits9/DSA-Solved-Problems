...
7 | [First negative integer in every window of size k](https://practice.geeksforgeeks.org/problems/first-negative-integer-in-every-window-of-size-k3345/1#) |   [Solution](https://github.com/nkits9/DSA-Solved-Problems/blob/master/c%2B%2B/First-negative-every-window-of-size-k.cpp) |_O(n)_ | _O(k)_ | Easy | Fixed Size SW |
